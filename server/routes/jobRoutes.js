...
import { closeJob, createJob, deleteJob, getAllJobs, getEmployerJob, getJobById, updateJobStats } from '../controllers/jobController.js';
...
router.post("/job-stats/:jobId",requireAuth,updateJobStats);
