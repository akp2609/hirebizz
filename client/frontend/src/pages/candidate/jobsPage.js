...
const JobsPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4">
            <h2 className="text-3xl font-extrabold text-blue-700 mb-6 tracking-wide drop-shadow-sm">
                Explore All Jobs
            </h2>
            ...
            {hasResume && relevantJobs.length > 0 && (
                <>
                    <h2 className="text-3xl font-extrabold text-blue-700 mb-6 tracking-wide drop-shadow-sm">Recommended Jobs Based on Your Resume</h2>
            ...
            <h2 className="text-3xl font-extrabold text-blue-700 mb-6 tracking-wide drop-shadow-sm">All Jobs Posted</h2>
