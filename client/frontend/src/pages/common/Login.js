...
const Login = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row min-h-screen w-full bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden'>
      ...
      {/* form side */}
      <div className='w-full lg:w-1/2 flex items-center justify-center p-4 min-h-screen relative z-10 overflow-y-auto'>
        <div className='bg-white/10 backdrop-blur-xl p-6 sm:p-10 md:p-12 rounded-3xl shadow-2xl border border-white/20 w-full max-w-md'>
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              <img
                ...
                alt="HireBizz Logo"
                className="h-14 sm:h-16 w-auto object-contain filter drop-shadow-lg"
              />
          ...
          <div className="text-center mb-8">
            <h1 className='font-bold text-white text-3xl sm:text-4xl mb-2 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent'>
              Welcome Back
            </h1>
            <p className="text-white/70 text-base sm:text-lg">Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            <div className="relative group">
              ...
              <input
                ...
                className='w-full pl-12 pr-4 py-3 sm:py-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl outline-none text-white placeholder-white/50 focus:border-blue-400 focus:bg-white/15 transition-all duration-300 text-base sm:text-lg'
                value={email}
            ...
            <div className="relative group">
              ...
              <input
                ...
                className='w-full pl-12 pr-12 py-3 sm:py-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl outline-none text-white placeholder-white/50 focus:border-blue-400 focus:bg-white/15 transition-all duration-300 text-base sm:text-lg'
                value={password}
            ...
            <button
              type='submit'
              disabled={loading}
              className='w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-3 sm:py-4 rounded-2xl hover:from-blue-600 hover:to-indigo-700 transform hover:scale-[1.02] transition-all duration-300 shadow-lg shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed text-base sm:text-lg'
            >
              {loading ? (
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            <GoogleLoginButton loading={loading} setLoading={setLoading} className="flex-1" />
            <GithubLoginButton loading={loading} setLoading={setLoading} className="flex-1" />
          </div>
      ...
      <div className='w-full lg:w-1/2 hidden lg:block relative overflow-hidden'>
        ...
        <img
          src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1974&q=80"
      ...
      {showForgotPassword && (
        <div className='fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto'>
          <div className='bg-white/10 backdrop-blur-xl p-6 sm:p-8 rounded-3xl shadow-2xl border border-white/20 w-full max-w-md'>
            <div className="text-center mb-6">
              <h2 className='text-xl sm:text-2xl font-bold text-white mb-2'>Reset Password</h2>
              <p className="text-white/70 text-sm sm:text-base">Enter your email to receive a reset link</p>
            </div>
            ...
            <div className="space-y-6">
              <div className="relative group">
                ...
                <input
                  ...
                  className='w-full pl-12 pr-4 py-3 sm:py-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl outline-none text-white placeholder-white/50 focus:border-blue-400 focus:bg-white/15 transition-all duration-300'
                />
              </div>

              <button
                type="button"
                className='w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-3 sm:py-4 rounded-2xl transform hover:scale-[1.02] transition-all duration-300 shadow-lg shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed'
