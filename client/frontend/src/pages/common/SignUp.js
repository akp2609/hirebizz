...
function SignUp() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 relative z-10">
        <div className="bg-white/10 backdrop-blur-xl p-8 sm:p-10 md:p-12 rounded-3xl shadow-2xl border border-white/20 w-full max-w-md relative overflow-y-auto max-h-[95vh]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 mb-6">
              <button
                ...
                className={`flex-1 p-4 rounded-2xl border-2 transition-all duration-300 transform hover:scale-[1.02] ${
                  !isEmployer
