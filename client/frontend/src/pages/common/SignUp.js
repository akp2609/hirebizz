    ...
    return (
        <div className='flex flex-col lg:flex-row h-screen w-full bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden'>
                ...
                <div className='bg-white/10 backdrop-blur-xl p-8 sm:p-10 md:p-12 rounded-3xl shadow-2xl border border-white/20 w-full max-w-md relative overflow-hidden'>
                    ...
                    <div className='text-center mt-8'>
                        <p className="text-white/70">
                            ...
                            <button className='text-purple-400 hover:text-purple-300 font-semibold transition-colors duration-300 hover:underline'>
                                Sign In
                            </button>
                        </p>
                    </div>
            ...
            <div className='w-full lg:w-1/2 hidden lg:block relative overflow-hidden'>
                ...
                <img
                    src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1971&q=80"
                    ...
                    <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-white/90 text-sub">Real-time collaboration tools</span>
                            </div>
                        </div>
                    </div>
                </div>
