    ...
    useEffect(() => {
        const fetchResume = async () => {
            try {
                ...
                setCurrentResume(user?.resumeURL || null);
            } finally {
                ...
                <div className="flex-1 overflow-y-auto p-6 sm:p-8">
                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-fadeIn">
                            {loadingResume ? (
                                <div className="flex items-center justify-center space-x-3 bg-blue-50 border border-blue-200 rounded-xl p-6">
                                    <div className="w-6 h-6 border-2 border-blue-500 border-t-transparent rounded-full animate-spin" />
                                    <span className="text-blue-700 font-medium">Fetching resume...</span>
                                </div>
                            ) : currentResume ? (
